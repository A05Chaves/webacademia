...
urlpatterns = [
    ...
    path('pagos/comprobante/<uuid:token>/',
         views.descargar_comprobante_pago, name='descargar_comprobante_pago'),
    path('pagos/<int:pago_id>/reenviar-comprobante/',
         views.reenviar_comprobante_pago, name='reenviar_comprobante_pago'),

    path('promociones-eventos/', views.promociones_eventos,
         name='promociones_eventos'),
    path('promociones/crear/', views.editar_promocion,
         name='crear_promocion'),
    path('promociones/<int:promocion_id>/editar/', views.editar_promocion,
         name='editar_promocion'),
    path('promociones/<int:promocion_id>/aplicar/', views.aplicar_promocion,
         name='aplicar_promocion'),
    path('eventos/crear/', views.editar_evento, name='crear_evento'),
    path('eventos/<int:evento_id>/editar/', views.editar_evento,
         name='editar_evento'),
    path('eventos/<int:evento_id>/categorias/crear/',
    ...
    path('eventos/categorias/<int:categoria_id>/guardar-llave/',
         views.guardar_llave_categoria, name='guardar_llave_categoria'),
    path('eventos/inscripciones/<int:inscripcion_id>/editar/',
         views.editar_inscripcion_evento, name='editar_inscripcion_evento'),
    path('eventos/inscripciones/<int:inscripcion_id>/mover-categoria/',
         views.mover_inscripcion_categoria, name='mover_inscripcion_categoria'),
